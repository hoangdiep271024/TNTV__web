...
import { filmInfo, filmShowing, filmShowTimeInfo, getComment, postComment } from "../../controllers/user/film.js";
...
routerFilm.post("/filmInfo/postComment/id=:id",postComment)
